...
class Profile(models.Model):
    ...
    _initial_first_name = None
    _initial_last_name = None

    def __init__(self,*args,**kwargs):
        super().__init__(*args,**kwargs)
        self._initial_first_name = self.first_name
        self._initial_last_name =  self.last_name
    ...
    def save(self,*args,**kwargs):
        ex = False
        to_slug=self.slug
        if self.first_name != self._initial_first_name or self.last_name != self._initial_last_name or self.slug=="":
...
class RelationshipManager(models.Manager):
    ...
    def invatations_received(self, reciever):
